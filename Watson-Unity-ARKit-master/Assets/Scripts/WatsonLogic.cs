...
public class WatsonLogic : MonoBehaviour
{
    ...
    public Text query, w_response;
    public InputField chatQuery;
    public GameObject queryObject, chatInput;
    ...
    private void Start()
    {
        ...
        queryObject = GameObject.Find("QueryObject");
